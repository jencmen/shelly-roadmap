            ...
            <div className="flex-grow bg-slate-50 hover:bg-white rounded-xl p-4 border border-slate-100 hover:shadow-md transition-all duration-300">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex gap-2">
                  <div className="w-6 flex-shrink-0 text-slate-400 mt-0.5">
                ...
                <div className="flex gap-2">
                  <div className="w-6 flex-shrink-0 text-amber-500 mt-0.5">
                ...
                <div className="flex gap-2">
                  <div className="w-6 flex-shrink-0 text-emerald-500 mt-0.5">
