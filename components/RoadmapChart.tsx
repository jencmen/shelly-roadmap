      ...
      <div className="flex-grow min-h-[300px] relative">
        ...
        <div className="absolute bottom-0 right-0 left-0 flex justify-center gap-6 text-xs text-slate-500">
           <div className="flex items-center gap-1">
             <span className="w-2 h-2 rounded-full bg-blue-500"></span> מוח (אסטרטגיה)
           </div>
           <div className="flex items-center gap-1">
             <span className="w-2 h-2 rounded-full bg-rose-500"></span> לב (רגש)
           </div>
           <div className="flex items-center gap-1">
             <span className="w-2 h-2 rounded-full bg-emerald-500"></span> רגליים (ביצוע)
           </div>
        </div>
      </div>
    </div>
